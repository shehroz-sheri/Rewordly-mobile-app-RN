  ...
  const handleRemovePlagiarism = async () => {
    if (wordCount === 0) {
      if (Platform.OS === 'android') {
        ToastAndroid.show(
          'Please paste or type text to remove plagiarism.',
          ToastAndroid.LONG,
        );
      } else {
    ...
    try {
      console.log('🚀 Starting plagiarism removal process...');
      ...
      console.log('✅ Plagiarism removal response received:', {
      ...
      if (data.success && data.data) {
        ...
        navigation.navigate('Result', {
          sourceScreen: 'PlagiarismRemover',
          originalText: inputText,
          resultText: processedText,
        });
        ...
        if (Platform.OS === 'android') {
          ...
          Alert.alert('Processing Complete', 'The plagiarism-free result is ready.');
        }
      } else {
        throw new Error('Backend did not return processed text');
      }
    } catch (error: any) {
      console.error('❌ Plagiarism removal failed:', error);
      Alert.alert(
        'Processing Failed',
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.topHeaderBar}>
        ...
        {/* Center: Screen Heading (Position Absolute for Perfect Center) */}
        <Text style={styles.screenHeadingAbsolute}>Plagiarism Remover</Text>

        {/* Removed headerSegmentRight */}
      </View>

      <View style={styles.introContainer}>
        <Text style={styles.headerTitle}>
          Rewrite your content to be original and plagiarism-free.
        </Text>
      </View>
      ...
      <View style={styles.footerContainer}>
        <View style={styles.actionRow}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}
          >
            <Text style={styles.removeButtonText}>Remove Plagiarism</Text>
          </TouchableOpacity>
        </View>
      </View>
...
export default PlagiarismRemoverScreen;
